 ...
 */
export declare function ComboboxRoot<Value, Multiple extends boolean | undefined = false>(props: ComboboxRootControlledProps<Value, Multiple>): React.JSX.Element;
export declare function ComboboxRoot<Value, Multiple extends boolean | undefined = false>(props: ComboboxRootUncontrolledProps<Value, Multiple>): React.JSX.Element;
...
type ComboboxRootBaseProps<Value, Multiple extends boolean | undefined> = Omit<AriaCombobox.Props<Value, ModeFromMultiple<Multiple>>, 'fillInputOnItemPress' | 'autoComplete' | 'submitOnItemClick' | 'autoHighlight' | 'keepHighlight' | 'highlightItemOnHover' | 'itemToStringLabel' | 'itemToStringValue' | 'isItemEqualToValue' | 'selectionMode' | 'defaultSelectedValue' | 'selectedValue' | 'onSelectedValueChange' | 'actionsRef' | 'onOpenChange' | 'onInputValueChange' | 'onItemHighlighted'> & {
  /**
...
type ComboboxRootControlledProps<Value, Multiple extends boolean | undefined> = ComboboxRootBaseProps<Value, Multiple> & {
  /**
   ...
   */
  onValueChange?: (value: ComboboxValueType<Value, Multiple>, eventDetails: ComboboxRoot.ChangeEventDetails) => void;
};
type ComboboxRootUncontrolledProps<Value, Multiple extends boolean | undefined> = ComboboxRootBaseProps<Value, Multiple> & {
  /**
   * The selected value of the combobox. Use when controlled.
   */
  value?: any;
...
type ComboboxRootComponentProps<Value, Multiple extends boolean | undefined> = ComboboxRootControlledProps<Value, Multiple> | ComboboxRootUncontrolledProps<Value, Multiple>;
export type ComboboxRootProps<Value, Multiple extends boolean | undefined = false> = ComboboxRootComponentProps<Value, Multiple>;
