...
import { safePolygon, useClick, useFloatingTree, useFocus, useHoverReferenceInteraction, useInteractions } from "../../floating-ui-react/index.js";
import { useFloatingNodeId, useFloatingParentNodeId } from "../../floating-ui-react/components/FloatingTree.js";
...
export const MenuTrigger = /*#__PURE__*/React.forwardRef(function MenuTrigger(componentProps, forwardedRef) {
  ...
  const props = [localInteractionProps.getReferenceProps(), hoverProps ?? EMPTY_OBJECT, isTriggerActive ? rootActiveTriggerProps : rootInactiveTriggerProps, {
    'aria-haspopup': 'menu',
    id: thisTriggerId,
    onMouseDown: event => {
  ...
  if (isOpenedByThisTrigger) {
    return /*#__PURE__*/_jsxs(React.Fragment, {
      ...
      }, `${thisTriggerId}-pre-focus-guard`), element, /*#__PURE__*/_jsx(FocusGuard, {
