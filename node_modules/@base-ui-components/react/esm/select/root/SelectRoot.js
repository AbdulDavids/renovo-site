...
export function SelectRoot(props) {
  ...
  const contextValue = React.useMemo(() => ({
    ...
    initialValueRef
  }), [store, name, required, disabled, readOnly, multiple, itemToStringLabel, itemToStringValue, setValue, setOpen, getItemProps, floatingContext.events, validation, onOpenChangeComplete, handleScrollArrowVisibility]);
