 ...
 */
export declare function SelectRoot<Value, Multiple extends boolean | undefined = false>(props: SelectRootControlledProps<Value, Multiple>): React.JSX.Element;
export declare function SelectRoot<Value, Multiple extends boolean | undefined = false>(props: SelectRootUncontrolledProps<Value, Multiple>): React.JSX.Element;
...
type SelectRootBaseProps<Value, Multiple extends boolean | undefined> = Omit<SelectRootCommonProps<Value>, 'multiple' | 'value' | 'defaultValue' | 'onValueChange'> & {
  /**
   * Whether multiple items can be selected.
   * @default false
   */
...
type SelectRootControlledProps<Value, Multiple extends boolean | undefined> = SelectRootBaseProps<Value, Multiple> & {
  /**
   * The value of the select. Use when controlled.
   */
   ...
   * Event handler called when the value of the select changes.
   */
  onValueChange?: (value: SelectValueType<Value, Multiple>, eventDetails: SelectRootChangeEventDetails) => void;
};
type SelectRootUncontrolledProps<Value, Multiple extends boolean | undefined> = SelectRootBaseProps<Value, Multiple> & {
  /**
   * The value of the select. Use when controlled.
   */
  value?: any;
...
export type SelectRootConditionalProps<Value, Multiple extends boolean | undefined = false> = SelectRootControlledProps<Value, Multiple> | SelectRootUncontrolledProps<Value, Multiple>;
export type SelectRootProps<Value, Multiple extends boolean | undefined = false> = SelectRootConditionalProps<Value, Multiple>;
